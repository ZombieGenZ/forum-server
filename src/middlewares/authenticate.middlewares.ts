...
export const authenticateUploadValidator = async (req: Request, res: Response, next: NextFunction) => {
  checkSchema(
    {
      authorization: {
        notEmpty: {
...
export const authenticateAdministratorUploadValidator = async (req: Request, res: Response, next: NextFunction) => {
  const user = req.user as User
