import { RegisterUserRequestBody } from '~/models/requests/users.requests'
...
class UserService {
  ...
  async register(payload: RegisterUserRequestBody) {
    ...
    email_welcome_subject = MAIL.WELCOME.subject
    email_welcome_html = MAIL.WELCOME.html
    email_verify_subject = MAIL.VERIFY_ACCOUNT(verifyUrl).subject
    email_verify_html = MAIL.VERIFY_ACCOUNT(verifyUrl).html
