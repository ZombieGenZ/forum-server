...
//  * }
//  */
// router.post('/verify-token', languageValidator, verifyTokenValidator, wrapRequestHandler(verifyTokenUserController))
...
//  * }
//  */
// router.post('/verify-account', languageValidator, verifyAccountValidator, wrapRequestHandler(verifyAccountController))
...
//  * }
//  */
// router.put('/forgot-password', languageValidator, forgotPasswordValidator, wrapRequestHandler(forgotPasswordController))
